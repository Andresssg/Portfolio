function ColombianFlag ({ className = '' }) {
  return (
    <svg className={className} xmlns='http://www.w3.org/2000/svg' aria-hidden='true' class='iconify iconify--twemoji' viewBox='0 0 36 36'>
