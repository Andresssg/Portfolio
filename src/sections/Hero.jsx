...
function Hero () {
  ...
  return (
    <section className='flex flex-col w-full h-screen p-14 pb-16 justify-end items-left bg-gradient-to-b from-secondary-light to-primary-light text-secondary-light'>
      ...
      <div className='flex gap-2 mt-2'>
        <Github className='w-7 hover:scale-150 hover:text-github duration-300' />
