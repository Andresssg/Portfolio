  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-y-4 md:w-[60ch]'>
        ...
        <p>Creo un porcentaje de niños suelen dejar algunos gustos de lado y yo hice parte de ese porcentaje. Comencé con nuevos gustos como el fútbol, videojuegos, series/YouTube, entre otros y me alejé de la programación.</p>
        <p>En mis últimos años de colegio no estaba seguro de que estudiar, pero finalmente regrese a lo que en un principio me interesaba <strong className='text-accent'>(programar)</strong> y decidí estudiar Ingeniería de Sistemas y así llegar al punto en el que estoy hoy.</p>
