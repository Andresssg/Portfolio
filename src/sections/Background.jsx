...
function Background () {
  return (
    <section id='background' className='flex flex-col w-full my-5 lg:my-16 mx-auto container lg:max-w-4xl md:max-w-2xl justify-center items-center text-accent'>
